...
public class RestaurantTimmsCashierTest extends TestCase {
	...
	public void testExactCustomerPayment() {
		...
		assertEquals("Check should be in queue.", Check.State.queue, cashier.getChecks().get(0).getState());
		assertTrue("Cashier's scheduler should return true.", cashier.runScheduler());
		assertEquals("Check should be unpaid.", Check.State.unpaid, cashier.getChecks().get(0).getState());
		...
		assertTrue("Cashier's scheduler should return true.", cashier.runScheduler());
		assertEquals("Check should be paid.", Check.State.paid, cashier.getChecks().get(0).getState());
	...
	public void testCustomerNonPayment() {		
		...
		assertTrue("Cashier's scheduler should return true.", cashier.runScheduler());
		assertEquals("Check should be unpaid.", Check.State.unpaid, cashier.getChecks().get(0).getState());
		assertEquals("Check should be for $20.", 20, cashier.getChecks().get(0).getAmount());
