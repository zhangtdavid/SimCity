...
//	MainFrame mainFrame;
//	CityViewPanel cityViewPanel;
	
	MarketPanel marketPanel;
	MarketBuilding market;
//	CityViewMarket cityViewBuilding;
	...
	public void setUp() throws Exception {
		...
		// The tests get complicated by the car animation. The MarketDeliveryPersonRole requires a pointer to the frame in application
		
//		mainFrame = new MainFrame();
//		cityViewPanel = new CityViewPanel(mainFrame);
//		mainFrame.cityView = cityViewPanel;
