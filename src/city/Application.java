...
public class Application {
	...
	private static void parseConfig() {
		...
		CityViewRestaurant cityViewRestaurantZhang1 = new CityViewRestaurant(150, 350, "Restaurant " + (mainFrame.cityView.getStaticsSize()), Color.magenta, restaurantZhangPanel1);
