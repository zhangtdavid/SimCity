...
public class MainFrame extends JFrame {
    ...
    public RestaurantChungPanel restaurantChungPanel;
    ...
    public MainFrame() {
        ...
        // Testing RestaurantChungPanel
        Dimension panelDimension = new Dimension(WINDOWX, WINDOWY);
        restaurantChungPanel = new RestaurantChungPanel(panelDimension);
        restaurantChungPanel.setPreferredSize(panelDimension);
        restaurantChungPanel.setMinimumSize(panelDimension);
        restaurantChungPanel.setMaximumSize(panelDimension);
        this.add(restaurantChungPanel);
    }
