...
//				}
//			}
//			cookInvoiceList.add(new CookInvoice(o.choice, 
//					cookInventory.get(o.choice).threshold - cookInventory.get(o.choice).amount, marketList.get(0)));
			stateChanged();
			return;
		} else {
...
//	}
	...
	private class CookInvoice {
		String food;
		int amount;
//		MarketAgent assignedMarket;
		CookInvoiceStatus status;
		
		CookInvoice(String food_, int amount_) {//, MarketAgent market_) {
			food = food_;
			amount = amount_;
