...
public class RestaurantJPWaiterRole extends Role implements RestaurantJPWaiter {
																		//DATA
	private List<MyCustomer> myCustomers = new ArrayList<MyCustomer>();
	RestaurantJPCookRole cook;
	RestaurantJPHostRole host;
	...
	public void setCook(RestaurantJPCookRole c)
	{
		cook = c;
	}
	...
	public void setCashier(RestaurantJPCashierRole csh){
		cashier = csh;
	}
	
	public RestaurantJPWaiterRole(String n) {
		super();
		name = n;					
	}
	
	public RestaurantJPWaiterRole(RestaurantJPCookRole p2r1, 
			RestaurantJPHostRole p3r1, RestaurantJPCashierRole p1r1, int i) {
